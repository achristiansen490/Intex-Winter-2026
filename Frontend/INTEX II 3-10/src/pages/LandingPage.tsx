        ...
        <section aria-labelledby="hero-heading" className="landing-hero">
          ...
          <div className="landing-hero-content">
            ...
            <div className="landing-hero-actions">
              <Link to="/login?returnUrl=/donor" style={{ background: c.gold, color: c.forest, fontSize: 14, fontWeight: 600, padding: '12px 28px', borderRadius: 28, textDecoration: 'none', display: 'inline-block' }}>
                Give Hope Today
              </Link>
        ...
        <section id="impact" aria-labelledby="cta-heading" className="landing-cta-section reveal-on-scroll">
          <div className="landing-cta-card">
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1.5rem', flexWrap: 'wrap' }}>
              ...
              <Link to="/login?returnUrl=/donor" style={{ background: c.gold, color: c.forest, fontSize: 14, fontWeight: 600, padding: '14px 32px', borderRadius: 28, textDecoration: 'none', whiteSpace: 'nowrap', display: 'inline-block' }}>
                Donate now
              </Link>
            </div>
          </div>
